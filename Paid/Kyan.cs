...
namespace Finals
{
    class Mathematics
    {
        ...
        {
            if (number2 == 0) { Console.WriteLine("Error: Division by zero is not allowed."); return 0; }
            return number1 / number2;
        }
    }
    ...
    class Activities
    {
        public void Activity1()
        {
            ...
            long studentLargeNumber = 9876543210;
            bool isStudentEnrolled = false;

            Console.WriteLine("This is an int: " + studentAge);
            Console.WriteLine("This is a string: " + studentNameAndCourse);
            Console.WriteLine("This is a char: " + studentGrade);
            Console.WriteLine("This is a float: " + studentScore);
            Console.WriteLine("This is a double: " + studentGPA);
            Console.WriteLine("This is a long: " + studentLargeNumber);
            Console.WriteLine("This is a bool: " + isStudentEnrolled);
        }
        ...
        public void Activity2()
        {
            ...
            long studentLargeNumber = 9876543210; // A large number for demonstration
            bool isStudentEnrolled = false; // Student's enrollment status

            // Output each variable with its type and value
            Console.WriteLine("This is an int: " + studentAge); // Output integer value
            Console.WriteLine("This is a string: " + studentNameAndCourse); // Output string value
            Console.WriteLine("This is a char: " + studentGrade); // Output char value
            Console.WriteLine("This is a float: " + studentScore); // Output float value
            Console.WriteLine("This is a double: " + studentGPA); // Output double value
            Console.WriteLine("This is a long: " + studentLargeNumber); // Output long value
            Console.WriteLine("This is a bool: " + isStudentEnrolled); // Output boolean value
        }
